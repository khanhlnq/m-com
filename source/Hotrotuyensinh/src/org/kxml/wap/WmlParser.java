...
public class WmlParser extends WbxmlParser {
     ...
     * 
     * public void ext_i (int id, String par) throws SAXException { String dec =
     * "$("+par+")";
     * 
     ...
     * 
     * while (stringTable [par] != 0) buf.append (stringTable [par++]);
     * 
     * ext_i (id, buf.toString ()); }
     * 
     * public void opaque (byte [] bytes) throws SAXException { throw new
     * SAXException ("OPAQUE invalid in WML"); }
     * 
     * public void ext (int id) throws SAXException { throw new SAXException
     * ("EXT_"+id+" reserved in WML"); }
     * 
     */
}
